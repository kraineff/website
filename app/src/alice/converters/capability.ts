...
export const CapabilityConverters = {
    "alarm_battery": () => Converter
        ...
        .createEvent("battery_level", run => run
            ...
            .getCapability<boolean>("alarm_battery", value => ["normal", "low"][+value])
        ),
    ...
    "alarm_co": () => Converter
        ...
        .createEvent("gas", run => run
            ...
            .getCapability<boolean>("alarm_co", value => ["not_detected", "detected"][+value])
        ),
    ...
    "alarm_co2": () => Converter
        ...
        .createEvent("gas", run => run
            .setParameters({ events: ["not_detected", "detected"] })
            .getCapability<boolean>("alarm_co2", value => ["not_detected", "detected"][+value])
        ),
    ...
    "alarm_contact": () => Converter
        ...
        .createEvent("open", run => run
            ...
            .getCapability<boolean>("alarm_contact", value => ["closed", "opened"][+value])
        ),
    ...
    "alarm_gas": () => Converter
        ...
        .createEvent("gas", run => run
            .setParameters({ events: ["not_detected", "detected"] })
            .getCapability<boolean>("alarm_gas", value => ["not_detected", "detected"][+value])
        ),
    ...
    "alarm_motion": () => Converter
        ...
        .createEvent("motion", run => run
            .setParameters({ events: ["not_detected", "detected"] })
            .getCapability<boolean>("alarm_motion", value => ["not_detected", "detected"][+value])
        ),
    ...
    "alarm_presence": () => Converter
        ...
        .createEvent("motion", run => run
            .setParameters({ events: ["not_detected", "detected"] })
            .getCapability<boolean>("alarm_presence", value => ["not_detected", "detected"][+value])
        ),
    ...
    "alarm_smoke": () => Converter
        ...
        .createEvent("smoke", run => run
            .setParameters({ events: ["not_detected", "detected"] })
            .getCapability<boolean>("alarm_smoke", value => ["not_detected", "detected"][+value])
        ),
    ...
    "alarm_tamper": () => Converter
        ...
        .createEvent("open", run => run
            .setParameters({ events: ["closed", "opened"] })
            .getCapability<boolean>("alarm_tamper", value => ["closed", "opened"][+value])
        ),
    ...
    "alarm_tank_open": () => Converter
        ...
        .createEvent("open", run => run
            .setParameters({ events: ["closed", "opened"] })
            .getCapability<boolean>("alarm_tank_open", value => ["closed", "opened"][+value])
        ),
    ...
    "alarm_vibration": () => Converter
        ...
        .createEvent("vibration", run => run
            ...
            .getCapability<boolean>("alarm_vibration", value => [undefined, "vibration"][+value])
        ),
    ...
    "alarm_water": () => Converter
        ...
        .createEvent("water_leak", run => run
            ...
            .getCapability<boolean>("alarm_water", value => ["dry", "leak"][+value])
        ),
